...
export default function EditExpenseScreen() {
  ...
  // Jika item tidak ditemukan di store
  if (!existingExpense) {
    return (
      <SafeAreaView className="flex-1 items-center justify-center bg-[#ffffff] px-6">
        <Ionicons name="alert-circle-outline" size={48} color="#cccccc" />
        <Text className="mt-4 text-base font-bold text-[#171717]">
          Transaksi Tidak Ditemukan
        </Text>
        <TouchableOpacity
          onPress={() => router.back()}
          className="mt-6 rounded-[8px] bg-[#7928ca] px-6 py-2.5">
    ...
    <SafeAreaView className="flex-1 bg-[#ffffff]" edges={['top']}>
      ...
      <View className="flex-row items-center justify-between border-b border-[#ebebeb] px-6 py-4">
        ...
        <TouchableOpacity
          ...
          className="h-9 w-9 items-center justify-center rounded-full border border-[#ebebeb] bg-white active:bg-red-50">
          <Ionicons name="trash-outline" size={18} color="#6d1fb5" />
        </TouchableOpacity>
      </View>
      ...
      {/* Pop Up Confirmation Hapus Transaksi (Shadcn UI Style) */}
      <Modal
